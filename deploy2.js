...
async function main() {
  ...
  // HTTP://0.0.0.0:7545
  const provider = new ethers.providers.JsonRpcProvider(process.env.RPC_URL); //no esta que reconoce si no es la v5.7.2 del paquete ethers
